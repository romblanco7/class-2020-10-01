...
d_2018_take_2 <- read_enrollment("raw_data/class_enrollment_summary_by_term_10.24.18.xlsx", 2)
d_2017_take_2 <- read_enrollment("raw_data/class_enrollment_summary_by_term_10.20.17.xlsx")
d_2016_take_2 <- read_enrollment("raw_data/class_enrollment_summary_by_term_fall_2016.xlsx",0)
d_2015_take_2 <- read_enrollment("raw_data/class_enrollment_summary_by_term_fall_2015.xlsx")

classes <- bind_rows(d_2019_take_2,d_2018_take_2,d_2017_take_2,d_2016_take_2,d_2015_take_2, .id = "year") %>%
...
q4 <- classes %>%
 group_by(year)%>%
  summarize(q_enrollment = list(quantile(u_grad)), .groups = "drop") %>%
mutate(mean_25_27 = mean(numbers[c(2,4)]))
 view(q4)
